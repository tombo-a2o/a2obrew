...
module Tombo
  class Test < CLIBase
    ...
    def upload(*_proj_names)
      # rubocop: disable Metrics/LineLength
      # Check profile
      dotfile = Dotfile.new
      unless dotfile.profile?(PROFILE)
      ...
      begin
        ...
        error_exit "`tombocli developers show` fails. Try to delete the profile #{PROFILE} on ~/.tombo/config"
      end
    end
  end
end
